...
.onLoad <- function(libname, pkgname) {
  ...
  op.mejr <- list(
    ggdistribute.font="Anton", mejr.pycustom="",
    mejr.viewdata.nrows=1000L, mejr.viewdata.pagesize=40L,
    mejr.viewdata.height="800px", mejr.viewdata.subsetfun="head",
    mejr.rfmt.cols=88, mejr.rfmt.compact=FALSE, mejr.use.rfmt=FALSE,
    mejr.use.styler=TRUE, mejr.selection.global=".last_text_selection",
