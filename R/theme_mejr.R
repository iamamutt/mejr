...
theme_mejr <- function(base_size = 11, madj = 0, black_level = 204,
  ...
  lines <- c("line", "hline", "vline", "linerange", "smooth", "errorbar", "errorbarh")
  ...
  ggplot2::update_geom_defaults("point", list(size = scale_add(base_size, .125),
  ...
  ggplot2::theme(
    line = element_line(colour = gray_color, size = scale_add(base_size, 0.025),
    linetype = 1, lineend = "square"
    ),
    rect = element_rect(fill = "transparent", colour = gray_color,
    ...
    margin = margin(t = scale_add(base_size, 0.5),
    ...
    title = element_text(
      ...
      size = scale_add(base_size, 1.2), hjust = 0, vjust = 0.5,
    ...
    axis.text.x = element_text(
      hjust = 0.5, vjust = 1,
      margin = margin(t = scale_add(base_size, 0.5, madj),
    ...
    axis.text.x.top = element_text(
      vjust = 0,
      margin = margin(t = scale_add(base_size, 0.25, madj),
      r = scale_add(base_size, 0.25, madj),
    ...
    axis.title.x.top = element_text(
      margin = margin(t = scale_add(base_size, 0),
      r = scale_add(base_size, 0),
      b = scale_add(base_size, 0.25, madj),
      l = scale_add(base_size, 0), unit = "pt"
      )
    ...
    legend.margin = margin(t = scale_add(base_size, 0.125),
    ...
    strip.text.x = element_text(
      hjust = 0.5, vjust = 0.5,
      margin = margin(t = scale_add(base_size, 0.35, madj),
      r = scale_add(base_size, 0),
    ...
    plot.caption = element_text(
      ...
      margin = margin(t = scale_add(base_size, 0.25),
      r = scale_add(base_size, 0.5),
      b = scale_add(base_size, 0.125),
      l = scale_add(base_size, 0.5), unit = "pt"
      )
    ),
    plot.margin = margin(t = scale_add(base_size, 0.15),
...
test_mejr_theme <- function(w = 6.875, h = 4.5, eplot = list(),
  ...
  p <- p + gg
  save_plot(p, file = normalizePath(file.path("~/../Desktop/test"), mustWork = F),
