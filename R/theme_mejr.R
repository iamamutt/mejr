...
#' @param madj additive adjustment of margin spacing and tick length (in "pt" units). May be
...
theme_mejr <- function(base_size = 11, madj = 0, black_level = 204,
    ...
    ggplot2::theme(
        ...
        axis.ticks.length = grid::unit(clip_range(scale_add(base_size, 0.15, madj), 0.15), "pt"),
...
test_mejr_theme <- function(w = 6.875,
                            h = 4.5,
                            eplot = list(),
