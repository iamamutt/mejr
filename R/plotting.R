...
test_mejr_theme <- function(..., s = 10, m = 0, w = 7, h = 5.5, d = TRUE)
{
    ggplot2::theme_set(theme_mejr(base_size = s, madj = m, debug_text = d))
    save_plot(
        example_plot(...),
...
#' @export
theme_mejr <- function(base_size = 9, madj = NULL, black_level = 204, font_type = "sans", debug_text = FALSE) {
