...
save_plot <- function(x, file, dir = NULL, width = 5.25, height = 3.8,
                      format = "pdf", font = getOption("mejr.font"), onefile = FALSE, res = 300,
                      fun = NULL,  ...)
{
...
#' @param pos character of \code{'tl'}, \code{'tr'}, \code{'bl'}, \code{'br'} to indicate position
...
#'
#' Creating font database only has to be done once or if installing a new font. Requires the
